...
_08002F14:
	lsls r1, r7, #6
	ldr r0, _080030C0 @ =gBG3MapBuffer+2
	adds r2, r1, r0
	...
	str r0, [r4, #8]
	ldr r0, [r4, #8]
	ldr r0, _080030D0 @ =gBG3MapBuffer+0x3E
	adds r3, r1, r0
	str r2, [r4]
	str r3, [r4, #4]
...
_08003186:
	...
	ldr r0, [r3, #8]
	adds r2, r1, r7
	ldr r7, _08003320 @ =gBG3MapBuffer+2
	adds r0, r1, r7
	str r2, [r3]
	str r0, [r3, #4]
	ldr r0, _08003318 @ =0x8000001E
...
_08003320: .4byte gBG3MapBuffer+2
...
sub_8003F7C: @ 0x08003F7C
	...
	ldr r0, [r1, #8]
_08003FA2:
	ldr r2, _08003FD8 @ =gBG0MapBuffer+0x404
	adds r2, #0x40
	movs r4, #0
	movs r1, #0
...
_08003FD8: .4byte gBG0MapBuffer+0x404
...
_080049F4:
	...
	movs r0, #2
	rsbs r0, r0, #0
	ldr r1, _08004A74 @ =gMain+0x3D
	ldrb r1, [r1]
	ands r0, r1
	ldr r2, _08004A74 @ =gMain+0x3D
	strb r0, [r2]
	movs r0, #0
	bl sub_8003F7C
_08004A12:
...
_08004C54:
	movs r0, #3
	rsbs r0, r0, #0
	ldr r4, _08004CB0 @ =gMain+0x3D
	ldrb r4, [r4]
	ands r0, r4
	movs r1, #0
	ldr r2, _08004CB0 @ =gMain+0x3D
	strb r0, [r2]
	mov r0, sp
	strh r1, [r0]
...
CopyBGDataToVramAndScrollBG: @ 0x08004FAC
	...
	mov r4, r8
	str r4, [sp, #8]
	ldr r0, _080050B8 @ =gMain+0x46
	ldrh r0, [r0]
	mov sb, r0
	mov r1, sb
	str r1, [sp, #0xc]
	ldr r2, _080050BC @ =gMain+0x4C
	ldrb r2, [r2]
	str r2, [sp, #0x10]
	ldr r3, _080050C0 @ =gMain+0x4D
	ldrb r3, [r3]
	str r3, [sp, #0x14]
	ldr r4, _080050C4 @ =gMain+0x4A
	ldrh r4, [r4]
	str r4, [sp, #0x1c]
	str r4, [sp, #0x18]
	adds r0, r6, #0
...
_08005012:
	...
	mov r4, sp
	ldrb r0, [r4, #4]
	ldr r4, _080050B4 @ =gMain+0x3E
	strb r0, [r4]
	mov r1, sp
	ldrb r2, [r1, #0x10]
	ldr r1, _080050BC @ =gMain+0x4C
	strb r2, [r1]
	mov r3, sp
	ldrb r4, [r3, #0x14]
	ldr r3, _080050C0 @ =gMain+0x4D
...
_080050B4: .4byte gMain+0x3E
_080050B8: .4byte gMain+0x46
_080050BC: .4byte gMain+0x4C
_080050C0: .4byte gMain+0x4D
_080050C4: .4byte gMain+0x4A
...
_08005DE0:
	...
	mov r8, r0
	ldr r7, _08005E48 @ =gTilemapBuffer+2
	mov r2, ip
	adds r2, #0x80
...
_08005E48: .4byte gTilemapBuffer+2
...
_08005FB8:
	...
	mov ip, sl
	ldr r7, _0800609C @ =gTilemapBuffer+2
	mov r2, r8
	adds r2, #0x80
...
_0800609C: .4byte gTilemapBuffer+2
...
_080061E6:
	ldr r3, _0800623C @ =gBG1MapBuffer+0x400
	lsls r0, r6, #1
	adds r3, r0, r3
	movs r4, #0
	adds r1, r0, #0
	ldr r5, _08006240 @ =gBG1MapBuffer+0x300
...
_0800623C: .4byte gBG1MapBuffer+0x380
_08006240: .4byte gBG1MapBuffer+0x300
