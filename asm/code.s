...
InitBGs: @ 0x080022D8
	...
	str r0, [r1, #8]
	ldr r0, [r1, #8]
	ldr r2, _08002340 @ =gBG1MapBuffer
	movs r1, #0
...
sub_8002354: @ 0x08002354
	...
	adds r0, #0x42
	mov ip, r0
	ldr r5, _080023BC @ =gBG3MapBuffer
_08002368:
	movs r2, #0
	lsls r0, r1, #4
	adds r4, r1, #1
...
_0800260E:
	...
	ldr r0, [r3, #8]
	adds r2, r1, r6
	ldr r6, _080026E8 @ =gBG3MapBuffer+0x2
	adds r0, r1, r6
	str r2, [r3]
	str r0, [r3, #4]
	mov r0, sl
...
_080026E8: .4byte gBG3MapBuffer+0x2
...
_0800275C:
	...
	mov ip, r1
	movs r5, #0
	ldr r7, _08002880 @ =gBG3MapBuffer+0x3E
	adds r7, #2
	str r7, [sp, #0x28]
	mov r0, sl
	str r0, [sp, #0xc]
_080027A4:
	lsls r0, r3, #6
	ldr r1, _08002880 @ =gBG3MapBuffer+0x3E
	adds r0, r0, r1
	str r0, [r2]
	ldr r7, [sp, #0x28]
	str r7, [r2, #4]
...
_08002880: .4byte gBG3MapBuffer+0x3E
...
_0800293C:
	mov r2, ip
	lsls r1, r2, #6
	ldr r3, _08002A0C @ =gBG3MapBuffer+0x2
	adds r2, r1, r3
	...
	str r3, [r4, #8]
	ldr r0, [r4, #8]
	ldr r0, _08002A18 @ =gBG3MapBuffer+0x3E
	adds r3, r1, r0
	str r2, [r4]
	str r3, [r4, #4]
...
_08002A0C: .4byte gBG3MapBuffer+0x2
_08002A10: .4byte gUnknown_03001880
_08002A14: .4byte gBG3MapBuffer
_08002A18: .4byte gBG3MapBuffer+0x3E
...
_08002C86:
	...
	strb r0, [r3]
_08002CA0:
	ldr r1, _08002D34 @ =gBG3MapBuffer+0x540
...
_08002D24:
	...
	bx r0
	.align 2, 0
_08002D34: .4byte gBG3MapBuffer+0x540
...
_08002D6E:
	...
	lsls r6, r0, #4
	mov sl, r2
	ldr r5, _08002D90 @ =gBG3MapBuffer+0x40
	adds r7, r4, #0
	adds r7, #0x4e
	str r7, [sp, #4]
	movs r0, #0x4f
	...
	b _08002DA0
	.align 2, 0
_08002D90: .4byte gBG3MapBuffer+0x40
_08002D94:
	movs r2, #1
	rsbs r2, r2, #0
	add r8, r2
...
_08002F14:
	lsls r1, r7, #6
	ldr r0, _080030C0 @ =gBG3MapBuffer+0x2
	adds r2, r1, r0
...
_080030C0: .4byte gBG3MapBuffer+0x2
...
_08003186:
	...
	ldr r0, [r3, #8]
	adds r2, r1, r7
	ldr r7, _08003320 @ =gBG3MapBuffer+0x2
	adds r0, r1, r7
	str r2, [r3]
	str r0, [r3, #4]
	ldr r0, _08003318 @ =0x8000001E
...
_08003320: .4byte gBG3MapBuffer+0x2
...
_080061E6:
	ldr r3, _0800623C @ =gBG1MapBuffer+0x380
	lsls r0, r6, #1
	adds r3, r0, r3
	movs r4, #0
	adds r1, r0, #0
...
sub_8010E38: @ 0x08010E38
	...
	push {r7}
	adds r7, r0, #0
	ldr r4, _08010F24 @ =gBG1MapBuffer+0x42
	adds r4, #2
	movs r2, #0
	adds r3, r7, #0
	adds r3, #0x9c
	...
	ldrsb r0, [r3, r0]
	adds r0, #1
	ldr r1, _08010F24 @ =gBG1MapBuffer+0x42
	mov r8, r1
	cmp r2, r0
	bhs _08010E90
	adds r6, r3, #0
...
_08010F1A:
	...
	bx r0
	.align 2, 0
_08010F24: .4byte gBG1MapBuffer+0x42

	thumb_func_start sub_8010F28
sub_8010F28: @ 0x08010F28
	push {r4, r5, r6, r7, lr}
	adds r7, r0, #0
	ldr r4, _08011008 @ =gBG1MapBuffer+0x78
	subs r4, #2
	movs r2, #0
	adds r3, r7, #0
	adds r3, #0x9c
	...
	ldrsb r0, [r3, r0]
	adds r0, #1
	ldr r1, _08011008 @ =gBG1MapBuffer+0x78
	mov ip, r1
	cmp r2, r0
	bhs _08010F76
	adds r6, r3, #0
...
_08011002:
	...
	bx r0
	.align 2, 0
_08011008: .4byte gBG1MapBuffer+0x78
...
sub_801100C: @ 0x0801100C
	...
	cmp r0, #2
	bls _0801102A
	ldr r1, _08011040 @ =gBG1MapBuffer+0x40
	movs r0, #0
...
_0801102A:
	...
	mov pc, r0
	.align 2, 0
_08011040: .4byte gBG1MapBuffer+0x40
