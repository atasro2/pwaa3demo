...
_0800DBB6:
	...
	adds r0, #1
	strb r0, [r6, #0xa]
	ldr r0, _0800DBCC @ =gMain+0x8
	ldr r0, [r0]
	str r0, [r6, #0xc]
	ldr r0, _0800DBD0 @ =gUnknown_02000007
	b _0800DC7E
	.align 2, 0
_0800DBCC: .4byte gMain+0x8
...
UpdateScrollPromptSprite: @ 0x0800E6A4
	push {r4, r5, r6, lr}
	adds r5, r0, #0
...
GetExaminedAreaSection: @ 0x0800E72C
	push {r4, r5, lr}
	sub sp, #8
	adds r5, r0, #0
	ldrh r1, [r5]
